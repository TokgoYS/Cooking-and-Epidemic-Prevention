  ...
  <body style="background-color:#F3EBE0">
	...
	<?php	
      ...
      while ($row = mysqli_fetch_assoc($result))
      {
		...
		<button id="btn1" value="add_data" onclick="location.href='apply_myNews.php'">申請人數</button>
		<button id="btn1" value="add_data" onclick="location.href='modify_myNews.php'">修改資料</button>
		<button id="btn1" value="add_data" onclick="location.href='delete_myNews.php'">刪除資料</button>
		<button id="btn2" value="add_data" onclick="location.href='myNews.php'">返回</button>
		</td>
		</tr>
  <?php
      }	
