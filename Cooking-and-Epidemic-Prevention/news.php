...
<html>
  ...
  <body style="background-color:#F3EBE0">
    ...
    <p align="center" style="padding-top:150px;"><h1 align="center" style="font-weight:bold">教學申請</h1></p>
	...
	<?php
      ...
      $sql = "SELECT * FROM journal ORDER BY jDate DESC";
      ...
      while ($row = mysqli_fetch_assoc($result) and $j <= $records_per_page)
      {
		...
		echo "<div align='right'><a href='show_news.php?id=";
