<?php
	...
	else
	{
		...
		$sql = "UPDATE member SET mName ='$name',mNickname='$nickname',mSex='$sex',mBirthday='$birthday',mPhone='$phone',mAddress='$address',mEmail='$email',mProfile='$profile' WHERE mNo =". $id;
...
<html>
  <head>
    <title align="center">修改會員資料成功</title>
    <meta charset="utf-8">
  ...
  <body style="background-color:#F3EBE0">
    ...
    <center>
	  ...
	  <tr align='center'><td bgcolor='#8F7B69' colspan='2' style='padding:20px'></td></tr>
		...
		<tr><td align="center" style='padding:20px'><button class="btn1" onclick="location.href='member_data.php'" ><strong>返回個人資料頁面</strong></td></tr>
     </table>
    </center>        
  </body>
</html>